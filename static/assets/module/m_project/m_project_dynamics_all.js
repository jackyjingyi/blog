...
;(function ($, window, document, undefined) {
    ...
    "use strict";
    var pluginName = "m_project_dynamics_all",
        defaults = {
        };
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            ...
            var html = template('m_project/m_project_dynamics_all', {});
        ...
        ,renderContent:function (t,callBack) {
            ...
            option.url = restApi.url_listDynamicOverview;
            ...
            m_ajax.postJson(option,function (response) {
                if(response.code=='0'){
                    ...
                    if(response.data.data && response.data.data.length>0){
                        ...
                        var html = template('m_project/m_project_dynamics_all_item',{dataList:response.data.data});
                ...
                switch (dataAction){
                    ...
                    case 'delDynamicsNotice'://删除动态
                        S_layer.confirm('删除后将不能恢复，您确定要删除吗？', function () {
                            var option = {};
                            option.url = restApi.url_deleteDynamicOverview;
                            option.postData = {
                                id:dataId
                            };
                            m_ajax.postJson(option, function (response) {
