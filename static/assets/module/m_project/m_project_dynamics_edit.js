...
;(function ($, window, document, undefined) {
    ...
    "use strict";
    var pluginName = "m_project_dynamics_edit",
        defaults = {
            isDialog:true,
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            var that = this;
            var   placeholderTitle = '添加动态文件';
            var html = template('m_project/m_project_dynamics_edit', {
        ...
        ,renderDialog:function (html,callBack) {
            ...
            if(that.settings.isDialog===true){//以弹窗编辑
                var dialogTitle =that.settings.id?'编辑动态': '添加动态';
        ...
        ,uploadRecordFile: function () {
            ...
            $(that.element).find('a[data-action="recordAttach"]').m_fileUploader({
                server: restApi.url_attachment_uploadDynamicOverviewFile,
                fileExts: '*',
        ...
        ,save:function (e) {
            ...
            options.url=restApi.url_saveDynamicOverview;
            options.postData = {};
