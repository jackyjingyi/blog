...
;(function ($, window, document, undefined) {
    ...
    "use strict";
    var pluginName = "m_project_payment",
        defaults = {
            contentEle:null,
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            ...
            var html = template('m_finance_confirm/m_project_payment',{});
        ...
        ,renderDataList:function () {
            ...
            paginationFun({
                ...
                if (response.code == '0') {
                    ...
                    var html = template('m_finance_confirm/m_project_payment_list',{
        ...
        ,getFeeType:function (callBack) {
            ...
            if(that._feeTypeList && that._feeTypeList.length>0){
                ...
                option.url = restApi.url_listProjectCategory+'/2';
