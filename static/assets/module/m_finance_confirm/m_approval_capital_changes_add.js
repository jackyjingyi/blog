...
;(function ($, window, document, undefined) {
    ...
    "use strict";
    var pluginName = "m_approval_capital_changes_add",
        defaults = {
            isDialog:true,
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            var that = this;
            var html = template('m_finance_confirm/m_approval_capital_changes_add', {
        ...
        ,renderDialog:function (html,callBack) {
            ...
            if(that.settings.isDialog===true){//以弹窗编辑
                ...
                S_layer.dialog({
                    title: that.settings.title||'资金变动',
                    area : '980px',
                    content:html,
                    cancel:function () {
                    },
        ...
        ,getApproverData:function (callBack) {
            var that = this;
            var option  = {};
            option.url = restApi.url_queryDynamicAuditForSingleFundChange+'/'+that._currentCompanyId;
        ...
        ,initExpTypeSelect2:function () {
            var that = this;
            var option = {};
            option.url = restApi.url_getExpCategoryTypeList3;
            option.postData = {};
        ...
        ,save:function () {
            ...
            option.postData.type = 'singleFundChange';
