    ...
    $.extend(Plugin.prototype, {
        ...
        , queryFileItems: function () {
            ...
            if(!that.settings.isBySearch){
                ...
                if(!isNullOrBlank(that.settings.dataCompanyId) && that.settings.url==restApi.url_getSkyDriverByProjectList)
                    ajaxOption.postData.companyId = that.settings.dataCompanyId;
        ...
        , initContextMenu:function (fileItems) {
            ...
            if($('.contextMenuBox.innerContentMenu').length>0)
                $('.contextMenuBox.innerContentMenu').remove();
            ...
            if(fileItems!=null && fileItems.length>0){
                $.each(fileItems, function (i, o) {
                    ...
                    if(!(o.editFlag == 1 || o.type == 1 || o.type==50 || (o.sendResults==1 && o.type==30)) ){
                        return true;
                    }
