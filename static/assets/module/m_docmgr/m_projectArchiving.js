    ...
    $.extend(Plugin.prototype, {
        ...
        , initDocmgrTree: function () {
            ...
            $tree.jstree({
                'core': {
                    ...
                    'data':function (node, callback) {
                        ...
                        if(node.id === '#'){
                            ...
                            option.postData.type = that._selectedNodeObj?that._selectedNodeObj.type:null;
                            m_ajax.postJson(option, function (response) {
                                if (response.code == '0') {
                ...
                if(selectBy==0){
                    ...
                    var firstId = $(that.element).find('.jstree-container-ul li:first').attr('id');
        ...
        , getFileItemsList:function () {
            ...
            options.renderCallBack = function () {
                ...
                new leftBoxHeightResize($(that.element).find('#documentTreeBox'),$(that.element).find('#documentTreeBox'),$(that.element).find('#fileItems'),51).init();
            };
