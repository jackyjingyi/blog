    ...
    $.extend(Plugin.prototype, {
        ...
        ,renderPage:function () {
            ...
            /*$('.summernote').summernote({
                ...
                toolbar: [
                    ...
                    ['height', ['height']],
                    ['insert',['picture','video','table','hr','link']],
        ...
        , bindClickFun: function () {
            ...
            $('.publishPublicNoticeOBox input[data-action="choseDepartment"]').bind('click', function (event) {
                ...
                options.ids = that._selectedIds;
                options.callBack = function (data) {
                    that._selectedIds = data;
            ...
            $(that.element).find('a[data-action]').bind('click', function (event) {
                ...
                switch (action){
                    case 'savePublish'://点击发送按钮
                        var orgList = [];
                        if(!isNullOrBlank(that._selectedIds)){
                            var list = that._selectedIds.split(',');
                        ...
                        if (that.savePublish_validate(that._selectedIds)) {
