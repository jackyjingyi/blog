...
;(function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        ,renderPage:function () {
            ...
            that._breadcrumb = [{name:'财务报表'},{name:'应收'}];
        ...
        ,bindGoExpensesPage:function () {
            ...
            $(that.element).find('a[data-action="goExpensesPage"]').off('click').on('click',function () {
                ...
                location.hash = '/project/cost?type=collectionPlan&id='+projectId+'&projectName='+encodeURI(projectName)+'&dataCompanyId='+window.currentCompanyId;
                return false;
            });
        }
        //筛选事件
