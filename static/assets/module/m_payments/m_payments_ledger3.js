...
;(function ($, window, document, undefined) {
    ...
    "use strict";
    var pluginName = "m_payments_ledger3",
        defaults = {
            contentEle:null,
    ...
    $.extend(Plugin.prototype, {
        ...
        ,renderPage:function () {
            var that = this;
            var html = template('m_payments/m_payments_ledger3',{});
        ...
        , renderDataList:function (t) {
            var that = this;
            var option = {};
            option.url = restApi.url_listClassicCompanyBill3;
            ...
            m_ajax.postJson(option, function (response) {
                if (response.code == '0') {
                    ...
                    var html = template('m_payments/m_payments_ledger3_list',that._dataInfo);
            ...
            $(that.element).find('button[data-action]').on('click',function () {
                ...
                switch (dataAction){
                    case 'exportDetails'://导出
                        ...
                        downLoadFile({
                            url:restApi.url_exportBalanceDetail3,
