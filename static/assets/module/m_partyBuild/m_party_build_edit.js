...
;(function ($, window, document, undefined) {
    ...
    "use strict";
    var pluginName = "m_party_build_edit",
        defaults = {
            isDialog:true,
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            var that = this;
            var   placeholderTitle = '添加党史学习教育';
            var html = template('m_partyBuild/m_party_build_edit', {
        ...
        ,renderDialog:function (html,callBack) {
            ...
            if(that.settings.isDialog===true){//以弹窗编辑
                var dialogTitle =that.settings.id?'编辑党史学习教育': '添加党史学习教育';
        ...
        ,uploadRecordFile: function () {
            ...
            $(that.element).find('a[data-action="recordAttach"]').m_fileUploader({
                server: restApi.url_attachment_uploadPartyBuildFile,
                fileExts: '*',
        ...
        ,save:function (e) {
            ...
            options.url=restApi.url_savePartyBuild;
            options.postData = {};
