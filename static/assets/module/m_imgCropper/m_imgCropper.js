...
;(function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        renderTemplate: function () {
            var that = this;
            var html = template('m_imgCropper/m_imgCropper', {thumbnailPreviewClass:that.settings.thumbnailPreviewClass});
        ...
        , saveCroppedImage: function () {
            ...
            var option = {};
            option.url = restApi.url_fastCutImage;
