...
;(function ($, window, document, undefined) {
    ...
    "use strict";
    var pluginName = "m_stats_user_output",
        defaults = {
        };
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            var that = this;
            var html = template('m_stats/m_stats_user_output',{});
        ...
        ,renderDataList:function (t) {
            ...
            option.url = restApi.url_listPersonalOutputStatic;
            ...
            m_ajax.postJson(option,function (response) {
                if(response.code=='0'){
                    ...
                    var html = template('m_stats/m_stats_user_output_list',{
            ...
            $(that.element).find('button[data-action]').off('click').on('click',function () {
                ...
                switch (dataAction){
                    ...
                    case 'exportDetails'://导出
                        ...
                        downLoadFile({
                            url:restApi.url_exportPersonalEfficiency,
