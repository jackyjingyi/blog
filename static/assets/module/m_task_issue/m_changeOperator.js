    ...
    $.extend(Plugin.prototype, {
        ...
        renderDialog:function (html,callBack) {
            ...
            if(that.settings.isDialog){//以弹窗编辑
                S_layer.dialog({
                    title: that.settings.title || '选择商务秘书',
                    area : '750px',
                    content:html,
                    cancel:function () {
                    },
        ...
        ,initHtmlTemplate:function () {
            ...
            that.getUserList(function (data) {
                var html = template('m_task_issue/m_changeOperator',{
                    orgUserList:data,
        ...
        ,getUserList:function (callBack) {
            var that = this;
            var options={};
            options.url= that.settings.type==1?restApi.url_listOperatorManager:restApi.url_listDesignManager;
