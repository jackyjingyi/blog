...
;(function ($, window, document, undefined) {
    ...
    "use strict";
    var pluginName = "m_technology_dynamics_edit",
        defaults = {
            title:null,
            isDialog:true,
            projectId:null,
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            var that = this;
            var html = template('m_technology_sync/m_technology_dynamics_edit',that.settings.dataInfo);
        ...
        renderDialog:function (html,callBack) {
            ...
            if (that.settings.isDialog === true) {//以弹窗编辑
                ...
                S_layer.dialog({
                    title: that.settings.title || '添加创新技术委员会信息动态',
                    area: '800px',
                    content: html,
                    cancel: function () {
                    },
        ...
        ,save:function () {
            ...
            option.url = restApi.url_saveSkillSynergyInfo;
            option.postData = $(that.element).find('form').serializeObject();
            option.postData.type = 5;
