...
;(function ($, window, document, undefined) {
    ...
    "use strict";
    var pluginName = "m_technology_show",
        defaults = {
            isDialog:true,
            type:null,
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            var that = this;
            var html = template('m_technology_sync/m_technology_show', {
                content:that.settings.content,
                title2:that.settings.title2,
                date:that.settings.date,
            });
        ...
        ,renderDialog:function (html,callBack) {
            ...
            if(that.settings.isDialog===true){//以弹窗编辑
                var   dialogTitle = '查看获奖情况';
               if(that.settings.type==5){
                    dialogTitle = '查看创新技术委员会信息动态';
                }
                S_layer.dialog({
