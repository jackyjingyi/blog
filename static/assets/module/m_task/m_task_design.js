...
;(function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            var that = this;
            var html = template('m_task/m_task_design',{});
        ...
        , renderDataList:function (t) {
            ...
            paginationFun({
                ...
                url: restApi.url_listTaskForProjectTask,
                params: option.param
            }, function (response) {
                ...
                if (response.code == '0') {
                    ...
                    var html = template('m_task/m_task_design_content',{
        ...
        ,bindActionClick:function () {
            ...
            $(that.element).find('a[data-action="toTaskContent"]').off('click').on('click',function () {
                ...
                switch (dataItem.myTaskType){
                    case 1:
                        location.hash = '/project/taskIssue/details?id='+dataItem.projectId+'&projectName='+encodeURI(dataItem.projectName)+'&dataCompanyId='+window.currentCompanyId+'&taskId='+dataId+'&fromType=1';
                        return false;
                        break;
                    case 2:
                    case 3:
                    case 13:
                        location.hash = '/project/production/details?id='+dataItem.projectId+'&projectName='+encodeURI(dataItem.projectName)+'&dataCompanyId='+window.currentCompanyId+'&taskId='+dataId+'&fromType=1';
                        return false;
                        break;
                }
            });
